...
#pragma warning disable format
        internal IValueTable CreateValueTable(bool isQuery)
            => (_code, isQuery) switch
            {
                ...
                (VRCode.FD, _)     => new ValueTable<FDValue>(),
                (VRCode.FL, _)     => new ValueTable<FLValue>(),
                (VRCode.IS, _)     => new ValueTable<ISValue>(),
                ...
                (VRCode.SS, _)     => new ValueTable<SSValue>(),
                ...
                (VRCode.US, _)     => new ValueTable<USValue>(),
        ...
        internal bool CreateValue<T>(ValueRef valueRef, T content, bool isQuery)
            => (_code, isQuery) switch
            {
                ...
                (VRCode.FD, _)     => valueRef.Set(FDValue.Create(content)),
                (VRCode.FL, _)     => valueRef.Set(FLValue.Create(content)),
                (VRCode.IS, _)     => valueRef.Set(ISValue.Create(content)),
                ...
                (VRCode.SS, _)     => valueRef.Set(SSValue.Create(content)),
                ...
                (VRCode.US, _)     => valueRef.Set(USValue.Create(content)),
        ...
        internal T GetContent<T>(ValueRef valueRef, bool isQuery)
            => (_code, isQuery) switch
            {
                ...
                (VRCode.FD, _)     => valueRef.As<FDValue>().Get<T>(),
                (VRCode.FL, _)     => valueRef.As<FLValue>().Get<T>(),
                (VRCode.IS, _)     => valueRef.As<ISValue>().Get<T>(),
                ...
                (VRCode.SS, _)     => valueRef.As<SSValue>().Get<T>(),
                ...
                (VRCode.US, _)     => valueRef.As<USValue>().Get<T>(),
                _ => throw new NotImplementedException(),
            };
        ...
        internal bool IsCompatible<T>(bool isQuery)
            => (_code, isQuery) switch
            {
                ...
                (VRCode.FD, _)     => FDValue.IsCompatible<T>(),
                (VRCode.FL, _)     => FLValue.IsCompatible<T>(),
                (VRCode.IS, _)     => ISValue.IsCompatible<T>(),
                ...
                (VRCode.SS, _)     => SSValue.IsCompatible<T>(),
                ...
                (VRCode.US, _)     => USValue.IsCompatible<T>(),
                _ => throw new NotImplementedException(),
            };
