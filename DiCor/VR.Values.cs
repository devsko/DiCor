...
#pragma warning disable format
        internal IValueTable CreateValueTable(bool isQuery)
            => (_code, isQuery) switch
            {
                ...
                (VRCode.DS, _)     => new ValueTable<DSValue>(),
                ...
                (VRCode.SL, _)     => new ValueTable<SLValue>(),
                ...
                _ => throw new NotImplementedException(_code.ToString()),
            };
        ...
        internal bool CreateValue<T>(ValueRef valueRef, T content, bool isQuery)
            => (_code, isQuery) switch
            {
                ...
                (VRCode.DS, _)     => valueRef.Set(DSValue.Create(content)),
                ...
                (VRCode.SL, _)     => valueRef.Set(SLValue.Create(content)),
        ...
        internal T GetContent<T>(ValueRef valueRef, bool isQuery)
            => (_code, isQuery) switch
            {
                ...
                (VRCode.DS, _)     => valueRef.As<DSValue>().Get<T>(),
                ...
                (VRCode.SL, _)     => valueRef.As<SLValue>().Get<T>(),
        ...
        internal bool IsCompatible<T>(bool isQuery)
            => (_code, isQuery) switch
            {
                ...
                (VRCode.DS, _)     => DSValue.IsCompatible<T>(),
                ...
                (VRCode.SL, _)     => SLValue.IsCompatible<T>(),
